...
for(i=Math.round(n/2)>0&&parseInt(e)-Math.round(n/2)>=1996?parseInt(e)-Math.round(n/2):1996;i<=(Math.round(n/2)>0&&parseInt(e)+Math.round(n/2)<=2090?parseInt(e)+Math.round(n/2):2090);i++)a+='<option value="'+i+'"'+(e==i?" selected":"")+">"+englishNo2Nep(i)+"<li>"
