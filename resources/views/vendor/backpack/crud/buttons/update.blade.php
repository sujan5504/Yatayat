@if ($crud->hasAccess('update'))
	...
	<!-- Single edit button -->
	<a href="{{ url($crud->route.'/'.$entry->getKey().'/edit') }}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Edit"><i class="la la-edit"></i></a>

	@else

	<!-- Edit button group -->
	<div class="btn-group">
	  <a href="{{ url($crud->route.'/'.$entry->getKey().'/edit') }}" class="btn btn-sm btn-success pr-0" data-toggle="tooltip" title="Edit"><i class="la la-edit"></i></a>
